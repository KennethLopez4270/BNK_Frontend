  ...
  <aside class="sidebar" :class="{ 'sidebar-collapsed': collapsed }">
    <div class="sidebar-header">
      <h2 class="logo" @click="toggleCollapse">
        <span v-if="!collapsed">Gestión de Clientes</span>
...
const props = defineProps({
  ...
  navConfig: {
    ...
    default: () => [
      ...
      { path: '/crear-cliente', title: 'Crear Cliente', icon: 'bi-person-plus' },
      { path: '/actualizar-cliente', title: 'Actualizar Cliente', icon: 'bi-person-check' },
      { path: '/obtener-clientes', title: 'Consultar Clientes', icon: 'bi-people' }
    ]
  }
});
