  ...
  <aside class="sidebar" :class="{ 'sidebar-collapsed': collapsed }">
    <div class="sidebar-header">
      <h2 class="logo" @click="toggleCollapse">
        <span v-if="!collapsed">Gestión de Préstamos</span>
...
const props = defineProps({
  ...
  navConfig: {
    type: Array,
    default: () => [
    { path: '/', title: 'Inicio Préstamos', icon: 'bi-house' },
    { path: '/crear-prestamo', title: 'Solicitar Préstamo', icon: 'bi-cash-stack' },
    { path: '/actualizar-prestamo', title: 'Modificar Préstamo', icon: 'bi-pencil-square' },
    { path: '/obtener-prestamos', title: 'Consultar Préstamos', icon: 'bi-file-earmark-text' },
    { path: '/eliminar-prestamo', title: 'Cancelar Préstamo', icon: 'bi-x-circle' }
    ]
  }
});
